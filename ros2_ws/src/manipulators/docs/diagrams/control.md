...
Mermaid diagrams for the control node architecture, startup/shutdown sequences, and low-level behavior.
...
graph TB
    ...
    PP -- /target_pose --> CB
    PP -- /gripper_command --> CB

    RS -- /color/image_raw --> OD
    RS -- /aligned_depth --> OD
    RS -- /camera_info --> OD
    OD -- /detected_object_point --> PP
